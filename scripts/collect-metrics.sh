...
SLUG_DIR="$HOME/.claude/projects/-Users-ybg-projects-products-bside-bside-bench"
SESSION_FILE=$(ls -t "$SLUG_DIR"/*.jsonl | head -1)
...
cp "$SESSION_FILE" "$OUT/raw/transcript.jsonl"
